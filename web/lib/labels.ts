...
// "pick the correct item" correction box when a user marks a prediction wrong.
// Keep in sync with inference/labels.py.
...
// Class names grouped by pathway, for a tidy grouped list.
